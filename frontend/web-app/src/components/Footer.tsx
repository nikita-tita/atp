...
const Footer: React.FC = () => {
  ...
  const footerLinks = {
    ...
    services: [
      { name: 'Торговая площадка', href: '/marketplace' },
    ...
    legal: [
      ...
      { name: 'Условия использования', href: '/conditions' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Специализированная площадка для верифицированной торговли авиатехникой. 
              Объединяем проверенных участников рынка для качественных сделок.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} ATP Platform. Все права защищены.
            </p>
            <div className="mt-4 md:mt-0 flex items-center space-x-6">
              <span className="text-gray-400 text-sm">
                Сделано с ❤️ для авиационной индустрии
              </span>
            </div>
          </div>
        </div>
