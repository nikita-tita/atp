    ...
    <div className="min-h-screen bg-gray-50 pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-500 mb-6">
          <Link to="/" className="hover:text-gray-700">{t('navigation.home')}</Link>
          <span>/</span>
          <Link to="/aircraft" className="hover:text-gray-700">{t('navigation.aircraft')}</Link>
          <span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
              <div className="p-6">
                ...
                <p className="text-lg text-gray-600 mb-4">{t('form.registration')}: {aircraft.registration}</p>
              ...
              <div className="p-6">
                {activeTab === 'overview' && (
                  <div className="space-y-6">
                    <div>
                      <h3 className="text-lg font-semibold mb-3">{t('comparePage.mainCharacteristics')}</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <span className="text-gray-500">{t('comparePage.manufacturer')}:</span>
                          <span className="ml-2 font-medium">{aircraft.manufacturer}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">{t('comparePage.model')}:</span>
                          <span className="ml-2 font-medium">{aircraft.model}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">{t('comparePage.year')}:</span>
                          <span className="ml-2 font-medium">{aircraft.year}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">{t('form.registration')}:</span>
                        ...
                        <div>
                          <span className="text-gray-500">{t('comparePage.cycles')}:</span>
                ...
                {activeTab === 'specifications' && (
                  <div className="space-y-6">
                    <div>
                      <h3 className="text-lg font-semibold mb-3">{t('comparePage.technicalCharacteristics')}</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <span className="text-gray-500">{t('comparePage.maxRange')}:</span>
                          <span className="ml-2 font-medium">{aircraft.specifications.maxRange}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">{t('comparePage.maxSpeed')}:</span>
                          <span className="ml-2 font-medium">{aircraft.specifications.maxSpeed}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">{t('comparePage.engines')}:</span>
                          <span className="ml-2 font-medium">{aircraft.specifications.engines}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">{t('comparePage.wingspan')}:</span>
                          <span className="ml-2 font-medium">{aircraft.specifications.wingspan}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">{t('comparePage.length')}:</span>
                          <span className="ml-2 font-medium">{aircraft.specifications.length}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">{t('comparePage.mtow')}:</span>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <h3 className="text-lg font-semibold mb-4">{t('aircraft.detail.sellerInfo', 'Seller Information')}</h3>
              
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <UserIcon className="h-5 w-5 text-gray-400" />
                  <div>
                    <div className="font-medium">{t('aircraft.detail.premiumSeller', 'Premium Seller')}</div>
                    <div className="text-sm text-green-600">✓ {t('dashboard.status.verified')}</div>
                  </div>
                </div>
                ...
                <div className="text-sm text-gray-600 bg-gray-50 p-3 rounded-lg">
                  ••••••••••••<br />
                  ••••••••••••<br />
                  {t('aircraft.detail.contactAfterCompliance', 'Contact information will be available after compliance check')}
                </div>
                ...
                <div className="flex space-x-2">
                  <button className="flex-1 flex items-center justify-center py-2 px-3 bg-gray-100 text-gray-600 rounded-lg text-sm">
                    ...
                    {t('aircraft.detail.call', 'Call')}
                  </button>
                  <button className="flex-1 flex items-center justify-center py-2 px-3 bg-gray-100 text-gray-600 rounded-lg text-sm">
                    <EnvelopeIcon className="h-4 w-4 mr-1" />
                    {t('aircraft.detail.email', 'Email')}
                  </button>
                </div>
              </div>
            </div>
      ...
      <ComplianceModal
        ...
        aircraft={{
          title: `${aircraft.year} ${aircraft.manufacturer} ${aircraft.model}`,
